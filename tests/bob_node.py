...
LND_REST = "https://127.0.0.1:8082"
TLS_CERT_PATH = "/Users/safwanonakkal/.polar/networks/5/volumes/lnd/bob/tls.cert"
MACAROON_PATH = "/Users/safwanonakkal/.polar/networks/5/volumes/lnd/bob/data/chain/bitcoin/regtest/admin.macaroon"
BACKUP_FILE = 'bob_channel_backup.json'
...
def deactivate_tower(pubkey):
    try:
        ...
        # print(pubkey_b64)
        pubkey_to_remove = "A5gmn+YfmiuGz+FyvHpQe/NN/uJzaiEtOHEKGHSFCWY/"

        pubkey_to_remove = "A5gmn+YfmiuGz+FyvHpQe/NN/uJzaiEtOHEKGHSFCWY/"
        # URL-safe encoding
        pubkey_urlsafe = pubkey_to_remove.replace('+', '-').replace('/', '_')
        # Sometimes you also need to remove the trailing '=' padding
